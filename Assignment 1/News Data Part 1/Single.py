...
def tokenize_sentence(line):
    ...
    words = preprocess(words) #Removes special chars
    words = remove_stopwords(words)#Removes stopwords
...
# Giving the count of selected words from vocabulary in each file
dictionary = {}
doc_num = 1
...
#Keys is the number for each file
dictionary.keys()
...
#X_train is a files x vocabulary size(no. of selected words) array, with the count of each word
# In[32]:
